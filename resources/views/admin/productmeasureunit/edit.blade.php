               ...
               <main>
                    ...
                    <h4 class="mt-4">Tables</h4>
                        ...
                        <div class="card mb-4">
                            ...
                            <form action="{{route('productmeasureunit.update', $productMeasureUnit->id)}}" method="POST" >
                            @csrf
                            @method('PUT')
  ...
  <div class="form-group">
    ...
    <input type="text" value="{{ $productMeasureUnit->name }}" name="name" class="form-control" id="">
  </div>
